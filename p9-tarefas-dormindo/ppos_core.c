...
static task_t *ready_queue;    // ponteiro para a fila de tarefas prontas
...
static void wake_tasks(void) {
#ifdef DEBUG
    queue_print("### [sleep_queue] ", (queue_t *)sleep_queue, print_elem);
#endif
    ...
    do {
        ...
        // devolve à fila de prontas as tarefas que já podem acordar
...
void task_sleep(int t) {
    current_task->wakeup_time = clock + t; // programa a hora de acordar
